...
##############################################################################################################
$config['deviceCode'] 		= '868209029773874';
$config['tk'] 				= 'ACHLC6u00OcfCHhU0QOAw8ZFbBAGbH75wgFxdHRodw';
$config['token'] 			= 'be4cjzUYR9lWMNet9KU9R2dWqXTltkGltp7EoHYoBXZYOrEgy3_EOIOVzdeD8qDnCCvNTahgO4JNrew'; // update after reboot
$config['uuid'] 			= '5433385d49a3400bb37900e5433cc265';
$config['sign'] 			= '18d14e98b111ade43330cc824ff62a02';  // update after reboot
$config['android_id'] 		= '5ccf625cc2fb3eae';
##############################################################################################################
